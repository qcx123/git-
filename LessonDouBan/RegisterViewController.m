...
- (IBAction)registerAction:(id)sender {
    ...
    if(self.userNameTextField.text.length == 0){
        ...
        [request RegisterWithUserName:self.userNameTextField.text passWord:self.passWordTextField.text avatar:[UIImage imageNamed:@"video.png"] success:^(NSDictionary *dic) {
